...
class Shopify_Processor:
    ...
    def update_product(self, product_id: str, product_json: dict):
        update_flag = False
        try:
            endpoint = f'products/{product_id}.json'
            counter = 0
    ...
    def update_product_image(self, product_id: str, json_value: dict) -> bool:
        updation_flag = False
        try:
    ...
    # insert new product
    def insert_product(self, brand: Brand, product: Product, product_title: str, product_description: str, tags: list[str]):
        try:
            ...
            while not flag:
                ...
                except Exception as e: self.print_logs(f'Exception in insert_product loop: {e}')
